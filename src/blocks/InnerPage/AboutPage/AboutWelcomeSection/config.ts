...
export const AboutWelcomeSuperChennaiBlock: Block = {
  ...
  fields: [
    ...
    // Flat Structure for Text Columns
    {
      name: 'columns',
      type: 'array',
      label: 'Text Columns',
      ...
      fields: [
        {
          name: 'col1',
          type: 'textarea',
          label: 'Column 1 Content / Paragraphs',
          admin: {
            description: 'Use line breaks for multiple paragraphs',
          },
        },
        {
          name: 'col2',
          type: 'textarea',
          label: 'Column 2 Content / Paragraphs',
        },
        {
          name: 'col3',
          type: 'textarea',
          label: 'Column 3 Content / Paragraphs',
        },
      ],
    },
  ],
