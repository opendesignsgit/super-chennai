...
//       },
//       options: [
//         { label: 'Live Page Banner Color', value: 'gradient-1' },
//         { label: 'Visit Page Banner Color', value: 'gradient-2' },
//         { label: 'Work Page Banner Color', value: 'gradient-3' },
//         { label: 'Invest Page Banner Color', value: 'gradient-4' },
//         { label: 'Innovate Page Banner Color', value: 'gradient-5' },
