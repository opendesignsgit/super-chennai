...
export const trendingChennaiContent = (slug: string, singular: string, plural: string): Block => ({
  slug,
  labels: {
    singular,
    plural,
...
export const trendingChennai: CollectionConfig<'trendingChennai'> = {
  slug: 'trendingChennai',
  access: {
...

            {
              ...
              fields: [
                ...
                },
                {
                  ...
                  label: 'trendingChennai Location',
                  required: true,
                  admin: {
